...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
	@Value("2cb684c5-54c7-4153-abd8-583e168a3ac2")
  ...
  JwtDecoder jwtDecoder() {
	...
	CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("http://localhost:8080", "http://bluestore-web-app-vuejs-ucllprep01.ocp-ucll-40cb0df2b03969eabb3fac6e80373775-0000.eu-de.containers.appdomain.cloud"));
